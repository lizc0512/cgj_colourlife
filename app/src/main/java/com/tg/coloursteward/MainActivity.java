...
public class MainActivity extends FragmentActivity implements ResponseListener, OnTabChangeListener, AMapLocationListener, LocationSource {
    ...
    public static final String ACTION_GET_USERINFO = "com.tg.coloursteward.ACTION_GET_USERINFO";
    ...
    private BroadcastReceiver freshReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (action.equals(ACTION_ACCOUNT_INFO)) {//刷新即时分配金额
                getAccountInfo();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String passWordMD5 = Tools.getPassWordMD5(this);
        Log.e(TAG, "onCreate: " + passWordMD5 + userName);
        /**
         * 开启服务
         */
        ...
        getAccessToken(userName, passWordMD5);//获取accessToken
        getRegisterAccount();//app注册数量
        getExamine1();
        getExamine2();
     ...
     * 获取APP注册数量
     */
    private void getRegisterAccount() {
        RequestConfig config = new RequestConfig(this, HttpTools.GET_REGISTER_ACCOUNT);
        RequestParams params = new RequestParams();
     ...
     * 获取审批数量1
     */
    private void getExamine1() {
        RequestConfig config = new RequestConfig(this, HttpTools.GET_EXAMINE1);
        RequestParams params = new RequestParams();
        params.put("username", UserInfo.employeeAccount);
     ...
     * 获取审批数量2
     */
    private void getExamine2() {
        RequestConfig config = new RequestConfig(this, HttpTools.GET_EXAMINE2);
        RequestParams params = new RequestParams();
        String access_token = Tools.getAccess_token(this);
        Log.e(TAG, "getExamine2: " + access_token + "   " + UserInfo.uid);
     ...
     * 获取access_token
     */
    private void getAccessToken(String userName, String passWordMD5) {
        RequestConfig config = new RequestConfig(this, HttpTools.GET_ACCESS_TOKEN);
        RequestParams params = new RequestParams();
        params.put("username", userName);
        params.put("password", passWordMD5);
        HttpTools.httpGet(Contants.URl.URL_ICETEST, "/auth2", config, params);
    }
    ...
    public void onSuccess(Message msg, String jsonString, String hintString) {
        ...
        } else if (msg.arg1 == HttpTools.GET_REGISTER_ACCOUNT) {
            if (code == 0) {
                JSONObject jsonObject = HttpTools.getContentJSONObject(jsonString);
                if (jsonObject.length() > 0) {
                    try {
                        ...
                        if (!quantity.equals("")) {
                            Tools.saveStringValue(this, "APP_REGISTER_ACCOUNT", quantity);
                            Log.e(TAG, "onSuccess:不空 quantity" + quantity);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                } else {
                    Log.e(TAG, "onFailed: " + hintString);
                }
            }
        } else if (msg.arg1 == HttpTools.GET_EXAMINE1) {
            if (code == 0) {
                JSONObject contentJSONObject = HttpTools.getContentJSONObject(jsonString);
                if (contentJSONObject != null) {
                    try {
                        String number = contentJSONObject.getString("number");
                        Log.e(TAG, "onSuccess:number " + number);//14
                        Tools.saveStringValue(this, "examine1", number);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
            }
        } else if (msg.arg1 == HttpTools.GET_EXAMINE2) {
            if (code == 0) {
    ...
    public void onFail(Message msg, String hintString) {
        ...
        if (msg.arg1 == HttpTools.GET_USER_INFO) {
            ...
            Log.e(TAG, "onFail: " + "GET_ACCESS_TOKEN");
        }
    }
