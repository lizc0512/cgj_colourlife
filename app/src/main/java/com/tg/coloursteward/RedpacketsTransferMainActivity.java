...
public class RedpacketsTransferMainActivity extends BaseActivity {
    private static final String TAG = "RedpacketsTransferMainA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            Log.e(TAG, "onCreate:receiverOA  " + receiverOA);
        }
        initView();
        initData();
        initOptions();
    ...
    private void initView() {
        ...
        imgHead = (RoundImageView) findViewById(R.id.riv_head_avatar);
