 ...
 * 对公账户搜索页
 */
public class PublicAccountSearchActivity extends BaseActivity implements HttpResponse {
    /**
     * 搜索当前架构/卡号
     */
        ...
        switch (v.getId()) {
            case R.id.right_layout://下一步
                ...
                if (etAccount.getText().toString().length() == 0) {
                    ToastUtil.showShortToast(PublicAccountSearchActivity.this, "请先输入组织架构或者卡号");
                    return false;
                }
    ...
    private void getAccountSearchInfo(String s) {
        bonusModel.postSearchDgzhList(0, accessToken, isAno, s, this);
    }
