...
public class AddWifiListAdapter extends BaseAdapter {
    ...
    public AddWifiListAdapter(Activity mContext, List<WiFiDetail> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.list_add_wifi_item, null);
            holder.SSID= (TextView) convertView.findViewById(R.id.tv_add_wifi_name);
            holder.BSSID=(TextView)convertView.findViewById(R.id.tv_add_bssid);
            holder.checkBox= (CheckBox) convertView.findViewById(R.id.cb_add_wifi);
