 ...
 * 个人处罚适配器
 */
public class PersionPunishmentAdapter extends MyBaseAdapter<BonusRecordDetailEntity.ContentBean.KkBean> {
    private LayoutInflater inflater;
    private Context context;
    private List<BonusRecordDetailEntity.ContentBean.KkBean> listinfo = new ArrayList<>();

    public PersionPunishmentAdapter(Context con, List<BonusRecordDetailEntity.ContentBean.KkBean> list) {
        super(list);
        this.listinfo = list;
        this.context = con;
    ...
    public void setData(List<BonusRecordDetailEntity.ContentBean.KkBean> list) {
        this.listinfo = list;
        context.notifyAll();
    }
