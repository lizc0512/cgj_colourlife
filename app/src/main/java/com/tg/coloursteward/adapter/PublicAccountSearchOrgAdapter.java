...
public class PublicAccountSearchOrgAdapter extends MyBaseAdapter<PublicAccountSearchInfo>{
	private ArrayList<PublicAccountSearchInfo> list;
	private LayoutInflater inflater;
	private PublicAccountSearchInfo item;
	private Context context;

	public PublicAccountSearchOrgAdapter(Context con, ArrayList<PublicAccountSearchInfo> list) {
		super(list);
		this.list = list;
		this.context = con;
