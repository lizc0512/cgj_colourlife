package com.tg.coloursteward.calendar;
...
public class CalendarCard extends View {
    ...
    protected Paint mCirclePaint; // 绘制圆形的画笔
    protected Paint mTextPaint; // 绘制文本的画笔
    protected int mViewWidth; // 视图的宽度
    protected int mViewHeight; // 视图的高度
    protected int mCellSpace; // 单元格间距
    protected Row rows[] = new Row[TOTAL_ROW]; // 行数组，每个元素代表一行
    protected static CustomDate mShowDate; // 自定义的日期，包括year,month,day
    protected OnCellClickListener mCellClickListener; // 单元格点击回调事件
...
//   }
     ...
     * @param row
     */
    protected void measureClickCell(int col, int row) {
