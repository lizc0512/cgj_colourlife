...
public class FragmentCentre extends Fragment implements AdapterView.OnItemClickListener {
    private View mView;
    ...
    private void addHead(){
        ...
        View userinfoView = inflater.inflate(R.layout.fragment_home_centre_userinfo, null);
