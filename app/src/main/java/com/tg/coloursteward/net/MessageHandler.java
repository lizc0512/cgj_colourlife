...
public class MessageHandler {
    public interface ResponseListener {
        void onRequestStart(Message msg, String hintString);

        void onSuccess(Message msg, String jsonString, String hintString);

        void onFail(Message msg, String hintString);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case HttpTools.RESPONSE_SUCCES:
                    ...
                    int result = HttpTools.getResult(responseString);
                    if (code != 301 || result != -1) {
                        ...
                        if (httpType == 0) {//get
                            ...
                            if (dataCount != null || datastr != null || code == 0 || code == 400 || code == 1 || result == 0) {
                                if (callback != null) {
                            ...
                            String dataCount = HttpTools.getContentString(responseString);
                            if (dataCount != null || code == 0 || result == 0) {
                                if (callback != null) {
