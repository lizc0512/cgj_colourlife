...
public class MessageService extends Service {
    ...
    public void onCreate() {
        ...
        HandlerThread handler = new HandlerThread("IntentService-message");
        handler.start();
        Looper looper = handler.getLooper();
        HandlerService handlerService = new HandlerService(looper);
...
//    }
    ...
    public String getServerMessage() {
        ...
        String Newtime = URLEncoder.encode(time);
        RequestParams params = new RequestParams();
        params.put("uid", UserInfo.uid);
        params.put("bTime", Newtime);
        String url = null;
        ...
        try {
            url = Contants.URl.URL_ICETEST + HttpTools.GetUrl(Contants.URl.URL_ICETEST, apiName, paramsStr);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
