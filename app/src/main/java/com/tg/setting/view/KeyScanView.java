...
public class KeyScanView extends View {

    private Paint mPaintCircleOrLine, mPaintArc2, mPaintLine;
    ...
    public KeyScanView(Context context) {
        super(context);
        initPaint();
    }

    public KeyScanView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }
    ...
    private void initPaint() {
        ...
        mPaintCircleOrLine.setStrokeWidth(5);
        mPaintCircleOrLine.setAntiAlias(true);
        mPaintCircleOrLine.setStyle(Paint.Style.STROKE);
        mPaintCircleOrLine.setColor(getResources().getColor(R.color.color_99ffffff));

        mPaintArc2 = new Paint();
        mPaintArc2.setAntiAlias(true);
        mPaintArc2.setColor(getResources().getColor(R.color.color_99ffffff));
        SweepGradient mShader = new SweepGradient(10, 10,
                Color.TRANSPARENT, Color.WHITE);
        mPaintArc2.setShader(mShader);

        mPaintLine = new Paint();
        mPaintLine.setStrokeWidth(1);
        mPaintLine.setStyle(Paint.Style.STROKE);
        mPaintLine.setAntiAlias(true);
        mPaintLine.setColor(getResources().getColor(R.color.color_99ffffff));
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        SweepGradient sweepGradient2 = new SweepGradient(mWidth / 2, mHeight / 2,
                Color.TRANSPARENT, getResources().getColor(R.color.color_99ffffff));
    ...
    protected class ScanThread extends Thread {
        ...
        private KeyScanView view;

        ScanThread(KeyScanView view) {
            this.view = view;
        }
