...
public class AxesRenderer {
    ...
    private Paint[] separationPaintTab = new Paint[]{new Paint(), new Paint(), new Paint(), new Paint()};
    ...
    public AxesRenderer(Context context, Chart chart) {
        ...
        for (int position = 0; position < 4; ++position) {
            ...
            separationPaintTab[position].setStyle(Paint.Style.STROKE);
            separationPaintTab[position].setAntiAlias(true);
        }
    }
    ...
    private void initAxisPaints(Axis axis, int position) {
        ...
        separationPaintTab[position].setColor(axis.getSeparationColor());
    ...
    private void drawAxisLines(Canvas canvas, Axis axis, int position) {
        ...
        if (axis.hasSeparationLine()) {
            ...
            canvas.drawLine(separationX1, separationY1, separationX2, separationY2, separationPaintTab[position]);
        }
        if (axis.hasLines()) {
            int valueToDrawIndex = 0;
