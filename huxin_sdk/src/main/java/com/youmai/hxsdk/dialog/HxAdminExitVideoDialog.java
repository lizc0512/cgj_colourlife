...
public class HxAdminExitVideoDialog extends Dialog {
    ...
    private Button btn_zhuangquan;

    private HxAdminExitVideoDialog(Build build) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hx_dialog_admin_exit_video);
        //按空白处不能取消
    ...
    private void initEvent() {
        ...
        if (threeListenner != null) {
            btn_zhuangquan.setOnClickListener(threeListenner);
        }
    }
    ...
    private void initData() {
        ...
        if (!TextUtils.isEmpty(threeText)) {
            btn_zhuangquan.setText(threeText);
        }
    }
    ...
    private void initView() {
        ...
        btn_zhuangquan = findViewById(R.id.btn_zhuanquan);
    }
    ...
    public static final class Build {
        ...
        public HxAdminExitVideoDialog build() {
            return new HxAdminExitVideoDialog(this);
        }
    }
}
