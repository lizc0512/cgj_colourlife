 ...
 */
public class SearchLoaderAct extends AsyncTaskLoader {

    private final String TAG = SearchLoaderAct.class.getSimpleName();

    private List<ContactBean> contactList;
    private String mQuery;
    private List<SearchContactBean> allList;

    public SearchLoaderAct(Context context, List<ContactBean> list) {
        super(context);
        contactList = list;
    }
