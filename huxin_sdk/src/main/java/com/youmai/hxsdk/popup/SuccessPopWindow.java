...
public class SuccessPopWindow extends PopupWindow {
	...
	public SuccessPopWindow(Context context) {
		...
		mPopupView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.hx_send_success_view, null);
	...
	private IOnSendCompleteListener listener;
	
	public interface IOnSendCompleteListener {
		void onSendSuccess();
	}
	
	public void setSendListener(IOnSendCompleteListener mListener){
