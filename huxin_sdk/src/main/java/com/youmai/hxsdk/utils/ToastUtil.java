...
public class ToastUtil {
    ...
    public static void showRepJoinToast(Context context, String message) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.hx_rep_tip_toast, null);
        ...
        mHandler.postDelayed(r3, 1800);// 延迟1秒隐藏toast
        mRepToast.show();
    }
