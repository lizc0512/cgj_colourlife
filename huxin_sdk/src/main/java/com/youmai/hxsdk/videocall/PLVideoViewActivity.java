...
//        options.setString(AVOptions.KEY_DNS_SERVER, "127.0.0.1");
        ...
        if (!mIsLiveStreaming && cache) {
            options.setString(AVOptions.KEY_CACHE_DIR, FileConfig.getFileDownLoadPath());
        }
        ...
        public void onInfo(int what, int extra) {
            ...
            switch (what) {
                ...
                case PLOnInfoListener.MEDIA_INFO_VIDEO_RENDERING_START:
                    Toast.makeText(PLVideoViewActivity.this, "first video render time: ", Toast.LENGTH_SHORT).show();
                    break;
        ...
        public boolean onError(int errorCode) {
            ...
            switch (errorCode) {
                ...
                case PLOnErrorListener.ERROR_CODE_OPEN_FAILED:
                    Toast.makeText(PLVideoViewActivity.this, "failed to open player ! ", Toast.LENGTH_SHORT).show();
                    break;
                case PLOnErrorListener.ERROR_CODE_SEEK_FAILED:
                    Toast.makeText(PLVideoViewActivity.this, "failed to seek ! ", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    Toast.makeText(PLVideoViewActivity.this, "unknown error !", Toast.LENGTH_SHORT).show();
                    break;
            }
            finish();
            return true;
    ...
    private PLOnCompletionListener mOnCompletionListener = new PLOnCompletionListener() {
        ...
        public void onCompletion() {
            ...
            Toast.makeText(PLVideoViewActivity.this, "Play Completed ! ", Toast.LENGTH_SHORT).show();
            if (!mIsLiveStreaming) {
