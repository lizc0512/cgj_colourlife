    ...
    public void toDaoHang(LatLng hisLatlng) {
        ...
        if (CommonUtils.isInstalled(mContext, "com.autonavi.minimap")) {// 判断是否安装了高德地图
            try {
                ...
                Toast.makeText(mContext, mContext.getString(R.string.hx_toast_60), Toast.LENGTH_SHORT).show();
                return;
            }
            return;
            ...
            try {
                ...
                Toast.makeText(mContext, mContext.getString(R.string.hx_toast_61), Toast.LENGTH_SHORT).show();
                return;
            }
            return;
        }

        Toast.makeText(mContext, mContext.getString(R.string.hx_toast_62), Toast.LENGTH_SHORT).show();
    }
