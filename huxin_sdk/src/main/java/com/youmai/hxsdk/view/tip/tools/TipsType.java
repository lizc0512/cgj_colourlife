...
public class TipsType {
    ...
    public static String TIP_EMO_KEEP = "收藏";//收藏表情
    ...
    public static List<TipBean> getRecEmotionType() {
        ...
        beanList.add(new TipBean("提醒", TIP_REMIND));
        beanList.add(new TipBean("转发", TIP_FORWARD));
        beanList.add(new TipBean("添加表情", TIP_EMO_KEEP));
        return beanList;
    }
    ...
    //语音(已经转过文字的)
    public static List<TipBean> getVoiceType2() {
        List<TipBean> beanList = new ArrayList<>();
        beanList.add(new TipBean("删除", TIP_DELETE));
        beanList.add(new TipBean("提醒", TIP_REMIND));
        beanList.add(new TipBean("收藏", TIP_COLLECT));
    ...
    //语音文本(已经转过文字的)
    public static List<TipBean> getVoiceType3() {
        List<TipBean> beanList = new ArrayList<>();
        beanList.add(new TipBean("删除", TIP_DELETE));
        beanList.add(new TipBean("提醒", TIP_REMIND));
        beanList.add(new TipBean("收藏", TIP_COLLECT));
    ...
    //电话
    public static List<TipBean> getCallType() {
        List<TipBean> beanList = new ArrayList<>();
        beanList.add(new TipBean("删除", TIP_DELETE));
        return beanList;
    }
    ...
    //位置共享
    public static List<TipBean> getLShareType() {
        List<TipBean> beanList = new ArrayList<>();
        beanList.add(new TipBean("删除", TIP_DELETE));
        return beanList;
    }
