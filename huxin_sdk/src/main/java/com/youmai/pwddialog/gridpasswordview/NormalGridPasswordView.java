package com.youmai.pwddialog.gridpasswordview;
...
import com.youmai.pwddialog.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
 ...
 * 15/3/5 21:30
 */
public class NormalGridPasswordView extends LinearLayout implements PasswordView {
    ...
    public NormalGridPasswordView(Context context) {
        super(context);
        initViews(context);
        init(context, null, 0);
    }

    public NormalGridPasswordView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public NormalGridPasswordView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NormalGridPasswordView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
