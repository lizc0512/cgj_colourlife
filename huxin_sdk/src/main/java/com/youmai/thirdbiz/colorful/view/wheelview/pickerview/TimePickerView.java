...
import com.youmai.thirdbiz.colorful.view.wheelview.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public TimePickerView(Context context, Type type) {
        ...
        LayoutInflater.from(context).inflate(R.layout.cgj_wheelview_pickerview_time, contentContainer);
        // -----确定和取消按钮
